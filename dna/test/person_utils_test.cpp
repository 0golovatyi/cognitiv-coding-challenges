...
std::vector<std::byte> fake_data2()
{
	std::vector<std::byte> data(1020);
	for (int i = 0; i < 1020; i++)
		data[i] = static_cast<std::byte>(rawdata2[i]);
	return data;
}

TEST_CASE("No interesting distinction for the same person", "[person]") {
    fake_person person1(std::array<std::vector<std::byte>, 23> {
			fake_data2(), fake_data2(), fake_data2(), fake_data2(), fake_data2(), fake_data2(),
			fake_data2(), fake_data2(), fake_data2(), fake_data2(), fake_data2(), fake_data2(),
			fake_data2(), fake_data2(), fake_data2(), fake_data2(), fake_data2(), fake_data2(),
			fake_data2(), fake_data2(), fake_data2(), fake_data2(), fake_data2()
	});

    fake_person person2(std::array<std::vector<std::byte>, 23> {
			fake_data2(), fake_data2(), fake_data2(), fake_data2(), fake_data2(), fake_data2(),
			fake_data2(), fake_data2(), fake_data2(), fake_data2(), fake_data2(), fake_data2(),
			fake_data2(), fake_data2(), fake_data2(), fake_data2(), fake_data2(), fake_data2(),
			fake_data2(), fake_data2(), fake_data2(), fake_data2(), fake_data2()
    ...
    auto res = dna::compare(person1, person2);
    REQUIRE(res.size() == 0);
}